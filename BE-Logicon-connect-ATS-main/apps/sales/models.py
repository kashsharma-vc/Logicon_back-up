...
class SalesRoleRequirement(TimeStampedModel):
    ...
    operational_base_wage = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    operational_base_wage_source = models.CharField(max_length=40, blank=True, default='')
    operational_base_wage_overridden = models.BooleanField(default=False)
    operational_base_wage_override_reason = models.TextField(blank=True, default='')
...
class SiteSurveyShiftDeployment(TimeStampedModel):
    ...
    base_wage_source = models.CharField(max_length=40, blank=True, default='')
    base_wage_overridden = models.BooleanField(default=False)
    base_wage_override_reason = models.TextField(blank=True, default='')
